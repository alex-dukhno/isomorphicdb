...
//     let row3 = vec![Datum::from_i16(7), Datum::from_i16(8), Datum::from_i16(9)];
//
//     insert_into(&mut with_small_ints_table, default_schema_name, "table_name", row1);
//     insert_into(&mut with_small_ints_table, default_schema_name, "table_name", row2);
//     insert_into(&mut with_small_ints_table, default_schema_name, "table_name", row3);
//
//     assert_eq!(
//         with_small_ints_table
//             .select_all_from(
...
//     let row1 = vec![
//         Datum::from_i16(1000),
//         Datum::from_i32(2000000),
//         Datum::from_i64(3000000000),
//     ];
//     let row2 = vec![
//         Datum::from_i16(4000),
//         Datum::from_i32(5000000),
//         Datum::from_i64(6000000000),
//     ];
//     let row3 = vec![
//         Datum::from_i16(7000),
//         Datum::from_i32(8000000),
//         Datum::from_i64(9000000000),
//     ];
//
//     insert_into(
//         &mut storage_with_schema,
