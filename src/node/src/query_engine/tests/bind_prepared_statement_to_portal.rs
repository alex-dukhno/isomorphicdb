...
// #[rstest::rstest]
// fn bind_insert_statement_to_portal(database_with_schema: (QueryExecutor, QueryParser, ResultCollector)) {
...
//
// #[rstest::rstest]
// fn bind_update_statement_to_portal(database_with_schema: (QueryExecutor, QueryParser, ResultCollector)) {
//     let (mut engine, mut parser, collector) = database_with_schema;
//
//     engine.execute(
//         &parser
