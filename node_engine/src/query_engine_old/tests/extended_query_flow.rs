...
mod jdbc_flow {
    ...
    fn insert(database_with_table: (InMemory, ResultCollector)) {
        ...
        engine
            .execute(InboundMessage::DescribeStatement { name: "".to_owned() })
        ...
        engine
            .execute(InboundMessage::DescribePortal { name: "".to_owned() })
            .expect("statement parsed");
        collector
            .lock()
            .unwrap()
        ...
        engine
            .execute(InboundMessage::Execute {
                portal_name: "".to_owned(),
                max_rows: 1,
            })
...
mod statement_description {
    ...
    fn statement_description(database_with_table: (InMemory, ResultCollector)) {
        ...
        engine
            .execute(InboundMessage::DescribeStatement {
