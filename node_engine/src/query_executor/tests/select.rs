...
fn select_all_from_table_with_multiple_columns(with_schema: TransactionManager) {
    ...
    assert_statement(
        ...
        vec![
            ...
            Outbound::DataRow(vec![small_int(123), small_int(456), small_int(789)]),
...
fn select_not_all_columns(with_schema: TransactionManager) {
    ...
    assert_statement(
        ...
        vec![
            ...
            Outbound::DataRow(vec![small_int(7), small_int(4)]),
            Outbound::DataRow(vec![small_int(8), small_int(5)]),
            Outbound::DataRow(vec![small_int(9), small_int(6)]),
...
fn select_first_and_last_columns_from_table_with_multiple_columns(with_schema: TransactionManager) {
    ...
    assert_statement(
        ...
        vec![
            ...
            Outbound::DataRow(vec![small_int(3), small_int(1)]),
            Outbound::DataRow(vec![small_int(6), small_int(4)]),
            Outbound::DataRow(vec![small_int(9), small_int(7)]),
            Outbound::RecordsSelected(3),
            Outbound::ReadyForQuery,
        ],
    );
...
fn select_all_columns_reordered_from_table_with_multiple_columns(with_schema: TransactionManager) {
    ...
    assert_statement(
        ...
        vec![
            ...
            Outbound::DataRow(vec![small_int(9), small_int(7), small_int(8)]),
            Outbound::RecordsSelected(3),
            Outbound::ReadyForQuery,
        ],
    );
...
fn select_different_integer_types(with_schema: TransactionManager) {
    ...
    assert_statement(&txn, "insert into schema_name.table_name values (1000, 2000000, 3000000000), (4000, 5000000, 6000000000), (7000, 8000000, 9000000000);", vec![Outbound::RecordsInserted(3), Outbound::ReadyForQuery]);
    assert_statement(
        &txn,
        "select * from schema_name.table_name;",
        vec![
            ...
            Outbound::DataRow(vec![small_int(1_000), integer(2_000_000), big_int(3_000_000_000)]),
            Outbound::DataRow(vec![small_int(4_000), integer(5_000_000), big_int(6_000_000_000)]),
            Outbound::DataRow(vec![small_int(7_000), integer(8_000_000), big_int(9_000_000_000)]),
            Outbound::RecordsSelected(3),
            Outbound::ReadyForQuery,
        ],
    );
...
fn select_different_character_strings_types(with_schema: TransactionManager) {
    ...
    assert_statement(
        ...
        "select * from schema_name.table_name;",
        vec![
            Outbound::RowDescription(vec![("char_10".to_owned(), CHAR), ("var_char_20".to_owned(), VARCHAR)]),
            Outbound::DataRow(vec![string("1234567890"), string("12345678901234567890")]),
