...
use sql_ast::{Assignment, Expr, Ident, ObjectType, Query, Select, SetExpr, Statement};
...
mod tests {
    ...
    use sql_ast::{BinaryOperator, ObjectName, SelectItem, TableFactor, TableWithJoins, Value, Values};
